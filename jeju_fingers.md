...
역시 어간을 분리하기 쉽지 않으나, ‘귀우비개’, ‘귀후비개’, ‘귀후개’ 등의 방언형으로 미루어 보아 ‘귀우개’는 ‘\*귀우의개’\~‘\*귀우이개’\~‘\*귀우위개’ 따위에서 3음절의 모음이 탈락한 어형임을 제안하고자 한다[^9]. 같은 이치로 ‘귀오개기’를 ‘귀-오-개기’로 보자면, ‘-개기’는 ‘ᄂᆞᆯ개기(날개, 지느러미)’, ‘ᄀᆞᆯ개기(호미)’에서도 나타나는바 ‘-개’와 유사하게 어떠한 행위에 사용되는 도구를 나타내는 접미사로 보인다.
